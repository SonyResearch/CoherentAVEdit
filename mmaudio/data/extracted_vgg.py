...
class ExtractedVGG(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        if 'extra_condition' in td:
            self.extra_condition = td['extra_condition']
        ...
        if local_rank == 0:
            ...
            if 'extra_condition' in td:
                log.info(f'Loaded extra_condition: {self.extra_condition.shape}.')
    ...
    def get_memory_mapped_tensor(self) -> TensorDict:
        ...
        if hasattr(self, 'extra_condition'):
            td['extra_condition'] = self.extra_condition
        return td
    ...
    def __getitem__(self, idx: int) -> dict[str, torch.Tensor]:
        ...
        if hasattr(self, 'extra_condition'):
            data['extra_condition'] = self.extra_condition[idx]
